	...
	throws ServletException, IOException
        ...
        try (Connection conexion = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proyecto", "postgres", "postgres")) {
          ...
          //Asociacion a usuario
            ...
            ResultSet resultSet2 = statement.executeQuery("select count(id) from playlist;");
            int id_playlist = Integer.parseInt(resultSet2.getString("count"));
            statement.executeUpdate("insert into tiene values ("  + nickname   +  ","+ id_playlist +");");
